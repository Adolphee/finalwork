 ...
 * Use the {@link FSearchFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FSearchFragment extends ListFragment implements android.widget.SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {
    ...
    public static FSearchFragment newInstance(ArrayList<Friend> ff) {
        FSearchFragment fragment = new FSearchFragment();
    ...
    public boolean onQueryTextChange (String charSequence){
        ...
        if (charSequence == null || charSequence.trim().isEmpty()) {
            adapter = new ListAdapter(friends, true);
            setListAdapter(adapter);
            return false;
        }
    ...
    public void setFriends(List<Friend> friends) {
        ...
        this.adapter = new ListAdapter(friends, true);
        setListAdapter(adapter);
    }
